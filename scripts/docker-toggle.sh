...
DOCKER_PKGS="dockerd docker docker-compose luci-lib-docker luci-app-docker luci-app-dockerman luci-i18n-docker-zh-cn luci-i18n-dockerman-zh-cn containerd runc tini"
